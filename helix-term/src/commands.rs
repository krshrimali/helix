...
impl MappableCommand {
    ...
    static_commands!(
        ...
        symbol_tree, "Open symbol tree view",
        symbol_tree_hsplit, "Open symbol tree view in horizontal split",
        breadcrumbs, "Open breadcrumbs picker showing parent symbols",
